...
% TITLE
% ============================================================
\node[font=\normalsize\bfseries] (title) at (0, 1.0)
    {Diagrama general del proceso de simulación};
\node[font=\scriptsize, text=black!60] at (0, 0.45)
    {Etapas comunes a los tres esquemas de acceso aleatorio};
