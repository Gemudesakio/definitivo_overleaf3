...
% === Title ===
\node[font=\normalsize\bfseries] at (3, 1.8)
    {MSG3 Resolution Procedure (Proposed Scheme)};
\node[font=\scriptsize, text=black!60] at (3, 1.3)
    {Per-transmission decision logic at the eNB, with scheduled/contender distinction};
