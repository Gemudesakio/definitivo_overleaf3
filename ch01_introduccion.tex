...
tecnologías de baja potencia como NB-IoT con infraestructura satelital~\cite{ref3, ref13}.
...
para aplicaciones IoT de baja latencia~\cite{ref3, ref6}. Sin embargo, el canal LEO
...
acceso aleatorio y pueden empeorar el problema de colisiones~\cite{ref6, ref13}.
...
señales~\cite{ref4, ref5}. Variantes más avanzadas, como SARA
...
de mensajes (MPA, \textit{Message Passing Algorithm})~\cite{ref10, ref17}.
...
detección basada en aprendizaje automático~\cite{ref20}, muestran que la precisión del
...
del 3GPP identifica como un problema abierto~\cite{ref13}.
